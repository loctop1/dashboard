...
export const kanbanGrid = [
  {
    headerText: 'Công Việc Phải Làm',
    keyField: 'Công Việc Phải Làm',
    allowToggle: true
  },

  {
    headerText: 'Công Việc Đang Xử Lý',
    keyField: 'Công Việc Đang Xử Lý',
    allowToggle: true
  },

  {
    headerText: 'Công Việc Cần Kiểm Tra',
    keyField: 'Công Việc Cần Kiểm Tra',
    allowToggle: true,
    isExpanded: false
  },

  {
    headerText: 'Công Việc Đã Hoàn Thành',
    keyField: 'Công Việc Đã Hoàn Thành',
    allowToggle: true
  },
];
...

  {
    ...
    links: [
      ...
      },
      {
        name: 'Nhân viên',
        icon: <IoMdContacts />,
        path: `/dashboard/${convertToSlug('Nhân viên')}`,
      },
      {
...
export const productsPerformance = [
  ...
  },
  {
    image:
      product6,
    title: 'Supreme Cà Chua Tươi available',
    desc: 'Market, Mall',
    rating: 'Excellent',
    itemSold: '98%',
...
export const customersData = [
  {
    CustomerID: 1001,
    CustomerName: 'Dương Chiến Thắng',
    CustomerEmail: 'thang123@gmail.com',
    CustomerImage:
      avatar2,
  ...
  },
  {
    ...
    CustomerName: 'Châu Duy Khánh',
    CustomerEmail: 'khanh345@gmail.com',
    ProjectName: 'Website Bất Động Sản',
    Status: 'Đã Kích Hoạt',
    CustomerImage:
      avatar3,
  ...
  },
  {
    ...
    CustomerName: 'Ngô Tuấn Long',
    CustomerEmail: 'long123k23@gmail.com',
    ProjectName: 'Website Du Lịch',
    Status: 'Đang Xử Lý',
    CustomerImage:
      avatar4,
    StatusBg: '#FEC90F',
  ...
  },
  {
    ...
    CustomerName: 'Nguyễn Tuấn Lộc',
    CustomerEmail: 'loc000@gmail.com',
    ProjectName: 'Website Khách Sạn',
...
export const kanbanData = [
  {
    Id: 'Nhiệm vụ 1',
    Title: 'Nhiệm vụ - 29001',
    Status: 'Công Việc Phải Làm',
    Summary: 'Phân tích các yêu cầu mới thu thập được từ khách hàng.',
    Type: 'Story',
    Priority: 'Low',
  ...
  {
    Id: 'Nhiệm vụ 2',
    Title: 'Nhiệm vụ - 29002',
    Status: 'Công Việc Đang Xử Lý',
    Summary: 'Cải thiện hiệu suất ứng dụng',
    Type: 'Improvement',
    Priority: 'Normal',
    Tags: 'Improvement',
    Estimate: 6,
  ...
  {
    Id: 'Nhiệm vụ 3',
    Title: 'Nhiệm vụ - 29003',
    Status: 'Công Việc Phải Làm',
    Summary: 'Sắp xếp một cuộc họp web với khách hàng để có được yêu cầu mới.',
    Type: 'Others',
    Priority: 'Critical',
    Tags: 'Meeting',
    Estimate: 5.5,
  ...
  {
    Id: 'Nhiệm vụ 4',
    Title: 'Nhiệm vụ - 29004',
    Status: 'Công Việc Đang Xử Lý',
    Summary: 'Khắc phục sự cố được báo cáo trong trình duyệt IE.',
    Type: 'Bug',
    Priority: 'Critical',
    Tags: 'IE',
    Estimate: 2.5,
  ...
  {
    Id: 'Nhiệm vụ 5',
    Title: 'Nhiệm vụ - 29005',
    Status: 'Review',
    Summary: 'Khắc phục các sự cố do khách hàng phản ánh.',
    Type: 'Bug',
    Priority: 'Low',
    Tags: 'Customer',
    Estimate: '3.5',
  ...
  {
    Id: 'Nhiệm vụ 8',
    Title: 'Nhiệm vụ - 29010',
    Status: 'Công Việc Đã Hoàn Thành',
    Summary: 'Kiểm tra ứng dụng trong trình duyệt IE.',
    Type: 'Story',
    Priority: 'Low',
    Tags: 'Review,IE',
    Estimate: 5.5,
  ...
  {
    Id: 'Nhiệm vụ 10',
    Title: 'Nhiệm vụ - 29015',
    Status: 'Công Việc Phải Làm',
    Summary: 'Hiển thị dữ liệu được truy xuất từ ​​máy chủ trong điều khiển lưới.',
    Type: 'Story',
    Priority: 'High',
    Tags: 'Database,SQL',
    Estimate: 5.5,
  ...
  {
    Id: 'Nhiệm vụ 11',
    Title: 'Nhiệm vụ - 29016',
    Status: 'Công Việc Đang Xử Lý',
    Summary: 'Sửa lỗi không thể mở cơ sở dữ liệu SQL mặc định của người dùng.',
    Priority: 'Critical',
    Type: 'Bug',
  ...
  {
    Id: 'Nhiệm vụ 13',
    Title: 'Nhiệm vụ - 29018',
    Status: 'Công Việc Đã Hoàn Thành',
    Summary: 'Phân tích kết nối máy chủ SQL 2008.',
    Type: 'Story',
    Priority: 'Critical',
    Tags: 'Grid,Sql',
    Estimate: 2,
  ...
  {
    Id: 'Nhiệm vụ 15',
    Title: 'Nhiệm vụ - 29020',
    Status: 'Công Việc Đã Hoàn Thành',
    Summary: 'Phân tích điều khiển lưới',
    Type: 'Story',
    Priority: 'High',
    Tags: 'Analyze',
    Estimate: 2.5,
  ...
  {
    Id: 'Nhiệm vụ 16',
    Title: 'Nhiệm vụ - 29021',
    Status: 'Công Việc Đã Hoàn Thành',
    Summary: 'Thủ tục lưu trữ để liên kết dữ liệu ban đầu của lưới.',
    Type: 'Others',
    Priority: 'Critical',
    Tags: 'Databinding',
    Estimate: 1.5,
  ...
  {
    Id: 'Nhiệm vụ 17',
    Title: 'Nhiệm vụ - 29022',
    Status: 'Công Việc Đã Hoàn Thành',
    Summary: 'Phân tích các thủ tục được lưu trữ',
    Type: 'Story',
    Priority: 'Critical',
    Tags: 'Procedures',
    Estimate: 5.5,
  ...
  {
    Id: 'Nhiệm vụ 20',
    Title: 'Nhiệm vụ - 29025',
    Status: 'Công Việc Phải Làm',
    Summary: 'Tăng cường chức năng chỉnh sửa.',
    Type: 'Improvement',
    Priority: 'Low',
    Tags: 'Editing',
    Estimate: 3.5,
  ...
  {
    Id: 'Nhiệm vụ 21',
    Title: 'Nhiệm vụ - 29026',
    Status: 'Công Việc Đang Xử Lý',
    Summary: 'Cải thiện hiệu suất của chức năng chỉnh sửa.',
    Type: 'Epic',
    Priority: 'High',
    Tags: 'Performance',
    Estimate: 6,
  ...
  {
    Id: 'Nhiệm vụ 22',
    Title: 'Nhiệm vụ - 29027',
    Status: 'Công Việc Phải Làm',
    Summary: 'Sắp xếp cuộc họp web với khách hàng để hiển thị bản demo chỉnh sửa.',
    Type: 'Others',
    Priority: 'High',
  ...
  {
    Id: 'Nhiệm vụ 24',
    Title: 'Nhiệm vụ - 29030',
    Status: 'Công Việc Cần Kiểm Tra',
    Summary: 'Khắc phục các sự cố do khách hàng phản ánh.',
    Type: 'Bug',
    Priority: 'Critical',
    Tags: 'Customer',
