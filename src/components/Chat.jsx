...
const Chat = () => {
    ...
    return (
        <div className="nav-item absolute right-5 md:right-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-auto">
            <div className="flex justify-between items-center">
                <div className="flex gap-3">
                    <p className="font-semibold text-lg dark:text-gray-200">Tin Nhắn</p>
                    <button type="button" className={`${currentMode === 'Dark' ? 'text-white' : 'text-black'} text-xs rounded p-1 px-2 bg-orange`}>
                        5 tin mới
                    </button>
                </div>
                <Button
